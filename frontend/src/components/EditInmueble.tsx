...
const EditInmueble = ({
  ...
  const handleSubmit = async (event: SubmitEvent<HTMLFormElement>) => {
    ...
    try {
      await api.patch(`/inmuebles/${inmueble.id}`, {
        address: address.toString() || inmueble.address,
        price: Number(price) || inmueble.price,
        squareMeters: Number(squareMeters) || inmueble.squareMeters,
        rooms: Number(rooms) || inmueble.rooms,
        propertyTypeId: propertyTypeId.toString() || inmueble.propertyTypeId,
      })
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <FormControlInput
            ...
            required
            autoComplete="area"
            defaultValue={inmueble.squareMeters}
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            defaultValue={inmueble.propertyTypeId}
          >
